...
public:
	...
	typedef int* (__thiscall* fnIssueOrder)(void* thisPtr, int Order, Vector* Loc, LActor* Target, bool IsAttackMove, bool IsMinion, DWORD Unknown);
	typedef float(__cdecl* fnGetAttackCastDelay)(LActor* pObj);
	typedef float(__cdecl* fnGetAttackDelay)(LActor* pObj);
	...
	typedef bool(__cdecl* fnIsHero)(LActor* pObj);
	typedef bool(__cdecl* fnIsMissile)(LActor* pObj);
	typedef bool(__cdecl* fnIsMinion)(LActor* pObj);
	typedef bool(__cdecl* fnIsTurret)(LActor* pObj);
	...
	typedef bool(__thiscall* fnIsAlive)(LActor* pObj);
	typedef bool(__thiscall* fnIsTargetable)(LActor* pObj);
};
